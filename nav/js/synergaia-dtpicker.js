/**
 * SynerGaïa 2.2 date picker avec heures
 * adapté de jquery-simple-datetimepicker (jquery.simple-dtpicker.js) v1.12.0
 * Original author : Masanori Ohgita - 2014 (https://github.com/mugifly/jquery-simple-datetimepicker)
 */
...
(function($) {
	...
	**/
	...
	var getParentPickerObject = function(obj) {
		return $(obj).closest('.sg-dtpicker');
	};
	...
	**/
	...
	var draw = function($picker, option, year, month, day, hour, min) {
		...
		/* Collect each part */
		var $header = $picker.children('.sg-dtpicker_header');
		var $inner = $picker.children('.sg-dtpicker_inner_container');
		var $calendar = $picker.children('.sg-dtpicker_inner_container').children('.sg-dtpicker_calendar');
		var $table = $calendar.children('.sg-dtpicker_table');
		var $timelist = $picker.children('.sg-dtpicker_inner_container').children('.sg-dtpicker_timelist');
		...
		if ($picker.data("dateOnly") === true) {
			...
			$timelist.css("height", $calendar.innerHeight() - 1 + 'px');
			**/
	...
	var init = function($obj, opt) {
		...
		/* Header */
		var $header = $('<div>');
		$header.addClass('sg-dtpicker_header');
		$picker.append($header);
		/* InnerContainer*/
		var $inner = $('<div>');
		$inner.addClass('sg-dtpicker_inner_container');
		$picker.append($inner);
		/* Calendar */
		var $calendar = $('<div>');
		$calendar.addClass('sg-dtpicker_calendar');
		var $table = $('<table>');
		$table.addClass('sg-dtpicker_table');
		$calendar.append($table);
		$inner.append($calendar);
		/* Timelist */
		var $timelist = $('<div>');
		$timelist.addClass('sg-dtpicker_timelist');
	 ...
	 * */
	 $.fn.appendDtpicker = function(config) {
		...
		return this.each(function(i) {
			...
			var $picker = $picker_parent.children('.sg-dtpicker');
